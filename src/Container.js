      ...
      <Row>
        <Col className="middle-picture" xs={4}>
          <div className="picture">
            ...
            <Button className="myBtn" bsStyle="primary" bsSize="large">Add to Cart</Button>
          </div>
        </Col>
        ...
        <Col className="middle-picture" xs={4}>
          <div className="picture">
            <div className="picture-title">Handguards</div>
        ...
        <Col className="middle-picture" xs={4}>
          <div className="picture">
            ...
            <img style={styles.products} src={require("./images/buffer.jpeg")} alt="reefles"/>
            <Button className="myBtn" bsStyle="primary" bsSize="large">Add to Cart</Button>
          </div>
        </Col>
        ...
        <Col className="middle-picture" xs={4}>
          <div className="picture">
            ...
            <img style={styles.products} src={require("./images/barrel.jpeg")} alt="reefles"/>
            <Button className="myBtn" bsStyle="primary" bsSize="large">Add to Cart</Button>
          </div>
        </Col>
        ...
        <Col className="middle-picture" xs={4}>
          <div className="picture">
            ...
            <img style={styles.products} src={require("./images/optic.jpeg")} alt="reefles"/>
            <Button className="myBtn" bsStyle="primary" bsSize="large">Add to Cart</Button>
          </div>
        </Col>
